**🌐 Personal Portfolio Website — CSS Core (Web Dev iLab Assignment 2)**

**📋 Project Overview**

This project is a personal portfolio webpage designed using HTML5 and an external CSS stylesheet.
It demonstrates the use of core CSS concepts such as selectors, the box model, positioning, and typography.
The page includes styled navigation, skill tables, buttons, and visual separators for a clean and professional layout.
...
👉 [https://github.com/Harshkrmu/Lab-Assignment-KRMU-Web-Dev-1]
